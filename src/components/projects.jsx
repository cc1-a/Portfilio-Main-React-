...
export const ProjectSection=()=>{
    return <section id="projects" className="py-24 px-4 relative">
        <div className="container mx-auto max-w-5xl">
                    ...
                    <div key={key} className="group bg-card rounded-lg overflow-hidden shadow-xs card-hover">
                        ...
                        <div className="flex justify-between items-center">
                            <div className="flex space-x-3">
                                ...
                                <a href={project.githubUrl}className="text-foreground/80 hover:text-primary transition-color duration 300" target="_blank"><Github size={20}/></a>
                            </div>
                        </div>
                        </div>
            ...
            <div className="text-center mt-12"><a className="cosmic-button w-fit flex items-center mx-auto gap-2" href="https://github.com/cc1-a/" target="_blank">Check My Github <ArrowRight size={16}/></a></div>
        </div>
    </section>
}
